...
static String[] usuariosTipos = new String[100]; // PROFESSOR ou
ALUNO
...
static int[][] turmasAlunos = new int[4][15]; // IDs dos alunosvinculados a cada turma
            ...
            case 4: // APROVAR (Professor)
                ...
                if (osProfessorResponsavel[idAp] == idPrAp &
                    ...
                    System.out.println("Materiais: " +
                            osMateriaisUsados[idAp]);
                    System.out.println("Laudo: " +
                            osConclusaoTecnica[idAp]);
                } else {
...
// CADASTRO DE PROFESSORES
    usuariosNomes[0] = "Mestre Ricardo (WEG)"; tipos[0] = "PROFESSOR";
